...
@media(max-width:640px){.home-clean-hero{padding-top:230px;background:#07121d}.home-clean-hero::before{height:250px!important;bottom:auto!important;background:url('/assets/hero-antenasrapid-HQ.jpg') 76% 42%/cover no-repeat!important}.home-clean-hero::after{content:'';position:absolute;left:0;right:0;top:150px;height:105px;z-index:-1;background:linear-gradient(180deg,rgba(7,18,29,0) 0%,#07121d 100%)}.home-clean-hero .hero-inner{min-height:0;padding-block:28px 34px}.home-clean-hero .hero-copy{width:100%;text-shadow:none}.home-clean-hero h1{font-size:clamp(38px,11vw,52px);color:#fff}.home-clean-hero .service-statement{font-size:18px;color:#fff}.home-clean-hero .lead{font-size:15px;color:#f2f3f5}.home-clean-hero .micro{color:#f2f3f5}.home-clean-hero .hero-tags{padding:14px 0;background:transparent;border:0;border-top:1px solid rgba(255,255,255,.18);border-radius:0;color:#fff}}
