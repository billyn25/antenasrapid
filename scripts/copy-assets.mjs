...
const heroSource=path.join('src','hero-antenasrapid.png');
const heroTarget=path.join(root,'assets','hero-antenasrapid.png');
if(!fs.existsSync(heroSource)) throw new Error('Falta src/hero-antenasrapid.png');
