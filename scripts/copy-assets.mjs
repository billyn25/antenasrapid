...
const heroSource=path.join('src','hero-antenasrapid-HQ.jpg');
const heroTarget=path.join(root,'assets','hero-antenasrapid-HQ.jpg');
if(!fs.existsSync(heroSource)) throw new Error('Falta src/hero-antenasrapid-HQ.jpg');
