...
test('las trece rutas base permanecen, sin generar clones nuevos', () => {
  assert.deepEqual(pages.map(p => p.path), ['/', '/Antenas-Alava/', '/Antenas-Bizkaia/', '/Antenas-Burgos/', '/Antenas-Cantabria/', '/Antenas-Guipuzcoa/', '/Antenas-Navarra/', '/Antenas-La-Rioja/', '/Antenas-Leon/', '/Antenas-Valladolid/', '/Antenas-Zamora/', '/Antenas-Bizkaia/bilbao.html', '/Antenas-Burgos/lerma.html']);
});
